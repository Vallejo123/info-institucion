            ...
            {items.map((it, idx) => (
              <div key={idx} className="rounded-2xl border p-4">
                ...
                <div className="mt-3 grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text_sm font-medium mb-1">Tiempo / época</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text_sm font-medium mb-1">Contexto local: problemáticas confrontadas</label>
                    <textarea
                      rows={3}
                  ...
                  <div>
                    <label className="block text_sm font-medium mb-1">Hechos de transformaciones positivas</label>
                    <textarea
                      rows={3}
                  ...
                  <div>
                    <label className="block text_sm font-medium mb-1">Personas / funcionarios / organizaciones destacadas por su solidaridad</label>
                    <textarea
                      rows={3}
        ...
        <section className="bg-white shadow-sm rounded-2xl p-5 border flex flex-wrap gap-3 items-center justify-between">
          ...
          <div className="flex gap-3">
            <button
              ...
              disabled={!isReady()}
              className={`rounded-xl px-4 py-2 text-sm font-medium border ${isReady() ? "hover:bg-gray-50" : "opacity-50 cursor-not-allowed"}`}
            >
              Descargar Excel
            </button>
            <button
